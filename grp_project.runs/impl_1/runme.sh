...
HD_PWD='C:/Users/Yi Xin/Downloads/tosend.xpr/grp_project/grp_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Coin_Flip_Page.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Coin_Flip_Page.tcl -notrace
