...
HD_PWD='C:/Users/Yi Xin/Downloads/tosend.xpr/grp_project/grp_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Coin_Flip_Page.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Coin_Flip_Page.tcl
